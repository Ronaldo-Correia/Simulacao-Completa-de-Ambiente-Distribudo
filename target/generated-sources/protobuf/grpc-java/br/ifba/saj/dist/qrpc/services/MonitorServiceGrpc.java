...
public final class MonitorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<br.ifba.saj.dist.qrpc.services.StatusRequest,
      br.ifba.saj.dist.qrpc.services.StatusResponse> getGetStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetStatus",
      requestType = br.ifba.saj.dist.qrpc.services.StatusRequest.class,
      responseType = br.ifba.saj.dist.qrpc.services.StatusResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<br.ifba.saj.dist.qrpc.services.StatusRequest,
      br.ifba.saj.dist.qrpc.services.StatusResponse> getGetStatusMethod() {
    io.grpc.MethodDescriptor<br.ifba.saj.dist.qrpc.services.StatusRequest, br.ifba.saj.dist.qrpc.services.StatusResponse> getGetStatusMethod;
      ...
      synchronized (MonitorServiceGrpc.class) {
        if ((getGetStatusMethod = MonitorServiceGrpc.getGetStatusMethod) == null) {
          MonitorServiceGrpc.getGetStatusMethod = getGetStatusMethod =
              io.grpc.MethodDescriptor.<br.ifba.saj.dist.qrpc.services.StatusRequest, br.ifba.saj.dist.qrpc.services.StatusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.ifba.saj.dist.qrpc.services.StatusRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.ifba.saj.dist.qrpc.services.StatusResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getStatus(br.ifba.saj.dist.qrpc.services.StatusRequest request,
        io.grpc.stub.StreamObserver<br.ifba.saj.dist.qrpc.services.StatusResponse> responseObserver) {
  ...
  public static final class MonitorServiceStub
    ...
    /**
     */
    public void getStatus(br.ifba.saj.dist.qrpc.services.StatusRequest request,
        io.grpc.stub.StreamObserver<br.ifba.saj.dist.qrpc.services.StatusResponse> responseObserver) {
  ...
  public static final class MonitorServiceBlockingStub
    ...
    /**
     */
    public br.ifba.saj.dist.qrpc.services.StatusResponse getStatus(br.ifba.saj.dist.qrpc.services.StatusRequest request) {
  ...
  public static final class MonitorServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<br.ifba.saj.dist.qrpc.services.StatusResponse> getStatus(
        br.ifba.saj.dist.qrpc.services.StatusRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STATUS:
          serviceImpl.getStatus((br.ifba.saj.dist.qrpc.services.StatusRequest) request,
              (io.grpc.stub.StreamObserver<br.ifba.saj.dist.qrpc.services.StatusResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              br.ifba.saj.dist.qrpc.services.StatusRequest,
              br.ifba.saj.dist.qrpc.services.StatusResponse>(
  ...
  private static abstract class MonitorServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return br.ifba.saj.dist.qrpc.services.MonitorProto.getDescriptor();
    }
